...
<body>
	...
	<div id="banner-bottom" class="banner-bottom">
		<div class="container">
			<h3 class="tittle">Inserire dati Prenotazione</h3>
		</div>
		<form method='post' action='addPrenotazione'>
			<label>Data esame </label><input type='date' name='data' /> <label>Seleziona
				un esame </label><select name='esame'>


			</select> <label>Seleziona un medico </label><select name='medico'>

			</select> <label>Seleziona il paziente </label><select name='paziente'>

			</select> <input type='submit' name='submit' value='aggiungi prenotazione' />
			</br>
			<a href='<c:url value="/areaAmministrazione" />'><span
				class="label label-danger annullabutton">Annulla Operazione</span></a>
		</form>
	</div>

<%@ page 
import = "it.uniroma3.clinica.entity.Medico, it.uniroma3.clinica.entity.Paziente,it.uniroma3.clinica.facade.Facade, java.util.*, it.uniroma3.clinica.entity.TipologiaEsame"
